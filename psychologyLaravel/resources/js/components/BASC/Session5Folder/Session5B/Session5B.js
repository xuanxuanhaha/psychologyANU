...
import styles from './session5b.module.css';
      ...
      <div className={styles.background_image} id="background_image">
        <div className={styles.whole_border}>
            ...
            <Typography title={'content'} position={'left'} color={'primary'} >
              {
                language === 'English' ?
                <p><u>First, do you have the Activity Planner with you for this session? If not, please get it ready as you will need it for the exercise below. </u></p>
                :
