...
import styles from './session1gradingb.module.css';
...
const Session1GradingB = () => {
  ...
  useEffect(() => {
    ...
    if(userData){
        axios.get(`/api/sessionresponse/1?userid=${userData.userid}&&questionno=session1GradingB`)
          .then(response => {
            if(response.data){
...
export default Session1GradingB;