...
import Session4worksheet4bWording from './Session4worksheet4bWording';

const Session4Worksheet4B = () => {
  ...
  const passData = () => {
    const data = {
        ...
        'sessionid': 4,
        'questionno': 'session4worksheet4b',
  ...
  const downloadCSV = () => {
    ...
    link.setAttribute('download', 'Session3Worksheet1Q4.csv');
...
export default Session4Worksheet4B;