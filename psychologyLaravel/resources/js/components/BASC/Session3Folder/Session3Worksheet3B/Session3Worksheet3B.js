      ...
      <div className={styles.background_image} id="background_image">
        <div className={styles.whole_border}>
          ...
          <Typography title={'content'} position={'left'} contentwidth={'100%'} >
              {
                language === 'English' ?
                <p>The remaining timeslots indicate your free time. Consider the activities that you planned in Exercise B-2, and select <b>up to TWO</b> activities that you are most confident in accomplishing. You may select just one activity if you do not have two activities. Make sure you select activities that you are definitely able to accomplish.</p>
                :
          ...
          <Typography title={'content'} position={'left'}  contentwidth={'100%'}>
              {
                language === 'English' ?
                'Write the selected activities in the space provided on the planner. Then, schedule the selected activities into the planner by writing the activity numbers down in the appropriate timeslots. '
                :
