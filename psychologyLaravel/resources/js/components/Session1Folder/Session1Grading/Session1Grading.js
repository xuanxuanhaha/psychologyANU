...
import styles from './session1grading.module.css';
...
const Session1Grading = () => {
  ...
  useEffect(() => {
    ...
    if(userData){
        axios.get(`/api/sessionresponse/1?userid=${userData.userid}&&questionno=session1Grading`)
          .then(response => {
            if(response.data){
...
export default Session1Grading;