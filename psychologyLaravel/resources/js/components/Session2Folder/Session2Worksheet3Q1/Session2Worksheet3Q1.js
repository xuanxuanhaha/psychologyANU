...
import styles from './session2worksheet3q1.module.css';
...
const Session2Worksheet3Q1 = () => {
  ...
  useEffect(() => {
    ...
    if(userData){
        axios.get(`/api/sessionresponse/2?userid=${userData.userid}&&questionno=session2worksheet2q2`).then(response => {
          if(response.data){
...
export default Session2Worksheet3Q1;