...
import styles from './session2worksheet2q2.module.css';
...
const Session2Worksheet2Q2 = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`/api/sessionresponse/2?userid=${userData.userid}&&questionno=session2worksheet2q2`)
    .then(response => {
    if(response.data){
        if(response.data.sessionresponse.response){
            const questionanswer = JSON.parse(response.data.sessionresponse.response)
  ...
  const passData = () => {
    ...
    const data = {
        ...
        'sessionid': 2,
        'questionno': 'session2worksheet2q2',
      ...
      <div className={styles.background_image} id="background_image">
        <div className={styles.whole_border}>
            ...
            <BorderContent>
                {
                    language === 'English' ?
                    <p> Now, let’s think about goals you might have in relation to academic-related  
...
export default Session2Worksheet2Q2;