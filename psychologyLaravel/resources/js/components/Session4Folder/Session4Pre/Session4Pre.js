...
import styles from './session4pre.module.css';
...
const Session4Pre = () => {
  ...
  useEffect(() => {
    ...
    if(userData){
        axios.get(`/api/sessionresponse/4?userid=${userData.userid}&&questionno=session4pre`)
          .then(response => {
            if(response.data){
    ...
    <div>
      ...
      <div className={styles.background_image} id="background_image">
        ...
        <div className={styles.whole_border}>
          ...
          <ProgressBar percentageNo={17} language={language} />
          <BorderContent>
            {
              language === 'English' ?
