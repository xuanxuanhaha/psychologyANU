...
import styles from './session4review2.module.css';
...
import Session4Review2Wording from './Session4Review2Wording';
import * as XLSX from 'xlsx';

const Session4Review2 = () => {
  ...
  const downloadCSV = () => {
    ...
    link.setAttribute('download', 'session4Review2.xlsx');
...
export default Session4Review2;