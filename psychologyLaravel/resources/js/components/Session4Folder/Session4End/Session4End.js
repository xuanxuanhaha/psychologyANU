     ...
     <div className={styles.background_image} id="background_image">
           <div className={styles.whole_border}>
             ...
             <div className={styles.question_content}>
               ...
               {language === 'English' ?
                 <p><i>Awesome, you have completed another session, we hope you are feeling calm and capable!</i></p>
                 :
             ...
             <Typography title={'content'} position={'left'} color={'primary'}>
               {language === 'English' ?
                 <p><i>Please take time to practice what you have learnt over the next week, then you will be ready to continue with session 5. Don’t worry, we’ll remind you by email when the next session is available. See you next week for our final session!</i></p>
                 :
                 <p>Tu as terminé la première séance, félicitations! Si tu le souhaites, tu peux passer immédiatement à la séance suivante. Si tu préfères, tu peux prendre une pause d'un ou deux jours. Nous t’enverrons des rappels par courriel pour que tu poursuives ton parcours afin de mieux l’inquiétude scolaire.</p>
               }
             </Typography>
