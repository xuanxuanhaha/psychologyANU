...
import styles from './session1gradingc.module.css';
...
const Session1GradingC = () => {
  ...
  useEffect(() => {
    ...
    if(userData){
        axios.get(`/api/sessionresponse/1?userid=${userData.userid}&&questionno=session1GradingC`)
          .then(response => {
            if(response.data){
  ...
  const jumptonextpage = () => {
    navigate(`/session1worksheet1startc`);
  };
      ...
      <div className={styles.background_image} id="background_image">
        ...
        <div className={styles.whole_border}>
          ...
          <BorderContent>
            {
              language === 'English' ?
                  "Research has shown that 25-40% of students experience worry towards their academic performance and competence. The following questions will check whether you worry about academic performance. Please rate the degree to which you have experienced each of the following in the PAST WEEK:"
                :
...
export default Session1GradingC;